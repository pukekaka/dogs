...
from test_code.mann2.util.init import weight_and_bias_init, shared_glorot_uniform, shared_one_hot
from test_code.mann2.util.similarities import cosine_similarity
from test_code.mann2.util.tf_utils import shared_float32
from test_code.mann2.util.tf_utils import update_tensor
